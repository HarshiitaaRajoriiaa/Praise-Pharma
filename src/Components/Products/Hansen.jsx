...
import CLOFAZIMINE_IMAGE from "../../Images/Products/DISEASES/CLOFAZIMINE.webp";

const clofazimine = [
  {
    name: "CLOFAZIMINE CAP",
    description: "Used for treating leprosy and certain skin conditions.",
    image: CLOFAZIMINE_IMAGE, // Replace with the actual image variable
  },
];

const Hansen = () => {
  const [flipped, setFlipped] = useState(Array(clofazimine.length).fill(false));
  ...
  return (
    <div className="p-6 mb-20">
      <h2 className="text-2xl font-bold mb-4 text-center">
        Hansen Disease Products
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {clofazimine.map((product, index) => (
