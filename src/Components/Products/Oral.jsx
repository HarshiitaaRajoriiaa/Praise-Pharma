...
import PRAISODOL_6MG from "../../Images/Products/ORAL/PRAISODOL6MG.webp";

const oral = [
  {
    name: "PRAISODOL 6MG TAB",
    description:
      "Effective treatment for inflammation and allergic conditions.",
    image: PRAISODOL_6MG,
  },
];

const Oral = () => {
  const [flipped, setFlipped] = useState(Array(oral.length).fill(false));
