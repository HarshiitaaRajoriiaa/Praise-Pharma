...
const sun =[
  {
    name:"Sunlyn SPF- 30 Lotion",
    description: "Sunlyn SPF-30 Lotion is a natural sunscreen that provides excellent protection against UVA and UVB rays.",
    image: SPF,
  }
]
const Sunscreen = () => {
  const [flipped, setFlipped] = useState(
    Array(sun.length).fill(false)
  );
  ...
  return (
    <div className="p-6 mb-20">
      ...
      Sun Block Fairness Lotion
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {sun.map((product, index) => (
