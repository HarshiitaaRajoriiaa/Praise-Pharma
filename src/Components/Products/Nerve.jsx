...
import KAPSI_GEL_20GM from "../../Images/Products/KapsiGel20gm.webp"
...
const kapsiGel = [
  {
    name: "Kapsi Gel 20gm",
    description: "Effective pain relief gel.",
    image: KAPSI_GEL_20GM,
  },
];

const Nerve = () => {
  const [flipped, setFlipped] = useState(
    Array(kapsiGel.length).fill(false)
  );
