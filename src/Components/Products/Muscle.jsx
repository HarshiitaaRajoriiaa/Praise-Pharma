...
import KAPSI_DICLO_GEL from "../../Images/Products/KAPSIDICLOGEL.webp";

const kapsiDicloGel = [
  {
    name: "KAPSI-DICLO GEL",
    description: "Fast-acting pain relief gel with diclofenac.",
    image: KAPSI_DICLO_GEL,
  },
];

const Muscle = () => {
  const [flipped, setFlipped] = useState(
    Array(kapsiDicloGel.length).fill(false)
  );
  ...
  return (
    <div className="p-6 mb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {kapsiDicloGel.map((product, index) => (
